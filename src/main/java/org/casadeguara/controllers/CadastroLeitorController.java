...
public class CadastroLeitorController implements GenericController {
    ...
    private Leitor construirLeitor(int idleitor, String nome) {
        return new LeitorBuilder(nome)
            .id(idleitor)
            .email(view.getEmailLeitor())
            .telefone1(view.getTelefone1Leitor())
            .telefone2(view.getTelefone2Leitor())
            .logradouro(view.getLogradouro())
            .bairro(view.getBairro())
            .complemento(view.getComplemento())
            .cep(view.getCep())
            .cpf(view.getCpfLeitor())
            .rg(view.getRgLeitor())
