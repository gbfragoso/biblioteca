...
public class LeitorBuilder {
	...
	public Leitor build() {
		return new Leitor(id, nome, email, telefone1, telefone2, logradouro, bairro, complemento, cep, cidade, sexo, rg,
				cpf, aniversario, ativo, trabalhador, paciente, incompleto);
	}
