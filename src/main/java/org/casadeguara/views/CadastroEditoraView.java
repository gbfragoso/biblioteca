...
public class CadastroEditoraView implements GenericView {
	...
	public CadastroEditoraView() {
		...
		painelEditora.getChildren().addAll(titulo, pesquise, pesquisarEditoras, lblCadastrar, txtNome, opcoes,
	...
	public SimpleObjectProperty<Editora> acaoPesquisarEditora() {
		return pesquisarEditoras.selectedValueProperty();
	}
