...
public class MenuLateral {
    ...
    public MenuLateral() {
        ...
        group.getToggles().addAll(movimentacao, consulta, reserva, cadastroAutor,
                cadastroEditora, cadastroLeitor, cadastroLivro, cadastroPalavra,
                graficos, impressos);
        group.selectToggle(movimentacao);
        
        menuLateral.getChildren().addAll(acervo, movimentacao, consulta, reserva,
                cadastro, cadastroAutor, cadastroEditora, cadastroLeitor, cadastroLivro,
                cadastroPalavra, estatisticas, graficos, impressos);
    }
