...
public class CadastroUsuarioView implements GenericView {
	...
	public CadastroUsuarioView() {
		...
		acessos.addAll("Movimentação", "Consulta", "Reserva", "Cadastro de autores", "Cadastro de editoras",
				"Cadastro de leitores", "Cadastro de livros", "Cadastro de palavras-chave", "Gráficos", "Impressos");
		...
		painelUsuario.getChildren().addAll(titulo, pesquise, pesquisarUsuarios, dados, lblNome, lblLogin, txtNome,
				txtLogin, lblAcessos, btnCadastrar, clvAcessos, opcoes, btnLimpar, btnAlterar, btnResetar, chbAdmin,
				chbAtivo);
	}
