...
public class CadastroLeitorView implements GenericView{
    ...
    public CadastroLeitorView() {
        ...
        painelLeitor.getChildren().addAll(titulo, pesquise, dadosPessoais, lblNome, lblCpf, lblRg, 
                lblLogradouro, lblBairro, lblComp, lblCep, lblEmail, lblTelefone1, lblTelefone2,
                lblSexo, opcoes, info, pesquisarLeitores, txtNome, txtEmail, txtTelefone1, txtTelefone2, 
                txtRg, txtCpf, txtLogradouro, txtBairro, txtComplemento, txtCep, 
                btnCadastrar, btnLimpar, btnAlterar, btnFicha, 
                cbbSexo, chbTrabalhador, chbInativo, chbIncompleto);
    }
