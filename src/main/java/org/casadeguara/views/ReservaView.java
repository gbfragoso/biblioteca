...
public class ReservaView implements GenericView {
	...
	public ReservaView() {
		...
		tabelaReserva.getColumns().addAll(tabelaReservaTombo, tabelaReservaTitulo, tabelaReservaLeitor,
				tabelaReservaData);
		...
		painelReserva.getChildren().addAll(titulo, lblReserva, pesquisarLeitores, pesquisarLivros, btnReservar,
				lblConsulta, btnCancelar, btnLimpar, pesquisarReservas, tabelaReserva);
	}
