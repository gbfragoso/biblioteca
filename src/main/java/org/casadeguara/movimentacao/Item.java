...
/**
 * Esta representa uma junção de algumas informações da tabela de exemplar e de empréstimo.
 * 
 * @author Gustavo
 * @since 1.0
 */
public class Item {
    ...
    /**
     * Ao criar um item para empréstimo, a data de devolução padrão utilizada é a da regra de negócio.
