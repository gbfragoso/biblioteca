...
/**
 * Esta classe se responsabiliza pela geração de janelas de diálogo para o
 * usuário.
 * 
 * @author Gustavo
 */
public class Alerta {
	...
	/**
	 * Exibe uma janela de confirmação para determinada ação e retorna qual foi a
	 * opção do usuário.
	 * 
	...
	public boolean confirmacao(String mensagem) {
		Alert confirmar = new Alert(Alert.AlertType.CONFIRMATION, mensagem, ButtonType.YES, ButtonType.NO);
	...
	/**
	 * Exibe uma janela de atenção para o usuário que irá realizar uma ação que
	 * requer cuidado.
	 * 
